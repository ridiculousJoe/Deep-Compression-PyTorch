...
print("original_accuracy = %f"%(original_accuracy))
util.log(args.log, f"original_accuracy = {original_accuracy}")
...
while 1:
    ...
    if (original_accuracy - accuracy > 1e-3):
        util.log(args.log, "Current model do not save due to accuracy too low")
        if (minus_cnt < 3):
            minus_cnt += 1
        else:
            break
        ...
        minus_cnt = 0
        util.log(args.log, "Save current model with:\n    %s"%(util.print_nonzeros(model)))
